...
public interface ClassRepository extends BaseRepository {
	...
	List<Map<String, Object>> getCollections(Long classUid, String gooruOid, int limit, int offset);
	...
	List<Map<String, Object>> getCourseData(String gooruOid, String collectionType);

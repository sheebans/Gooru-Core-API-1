...
public class CollectionBoServiceImpl extends AbstractResourceServiceImpl implements CollectionBoService, ParameterProperties, ConstantProperties {
	...
	public void updateQuestion(String collectionId, String collectionQuestionItemId, String data, User user) {
		...
		getCollectionEventLog().collectionItemEventLog(collectionId, collectionItem, user.getPartyUid(), QUESTION, data, EDIT);
	...
	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
	public void moveCollection(Map<String, String> sourceCourse, String courseId, String unitId, String lessonId, String collectionId, User user) {
		...
		this.getCollectionEventLog().getMoveEventLog(sourceCourse.get(SOURCE_COURSE_ID), unitId, lessonId, collection, user, collection.getContentType().getName());
